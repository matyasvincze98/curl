...
def get_data_sources(dataset, dataset_kwargs, batch_size, test_batch_size,
  ...
  patches_128k_train_dict['train_labels'] = [int(item) for item in patches_128k_train_dict['train_labels'][:num_train]]
  ...
  patches_128k_test_dict['test_labels'] = [int(item) for item in patches_128k_test_dict['test_labels'][:num_test]]
  ...
  num_test_examples = len(patches_128k_test_dict['test_labels'])
